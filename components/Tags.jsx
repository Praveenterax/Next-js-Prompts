...
const Tags = ({ tags = [], setTags = () => {} }) => {
  ...
  return (
    <div className="w-full flex flex-row flex-wrap gap-2 p-2 border-none bg-white rounded mt-2 text-sm text-gray-500">
      {tags.map((tag, index) => (
      ...
      <input 
        type="text"
        className={`grow border-none outline-none bg-inherit ${isDisabled ? 'cursor-not-allowed' : ''}`}
        value={tagName}
